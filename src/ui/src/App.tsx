...
function App() {
  ...
  useEffect(() => {
    ...
    getAppSetting("usage_insights_enabled")
      ...
      .catch(() => {});
    getAppSetting("dashboard_mode_enabled")
      .then((val) => { if (val === "true") setDashboardModeEnabled(true); })
      .catch(() => {});
