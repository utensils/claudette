...
## [0.29.0](https://github.com/utensils/claudette/compare/v0.28.0...v0.29.0) (2026-09-22)
...
* **models:** add Claude Opus 5.5 and GPT-6 Sol / Luna ([#1031](https://github.com/utensils/claudette/issues/1031)) ([a69a1fc](https://github.com/utensils/claudette/commit/a69a1fc496902084c4cc68c55f4038c1427dfcaf))
...
* **agent:** add MCP tools for agent-initiated user interaction ([#997](https://github.com/utensils/claudette/issues/997)) ([ed01230](https://github.com/utensils/claudette/commit/ed01230b160361db5d34e9274d4fd44841ae649e))
...
* **models:** add Sonnet 5 and demote Sonnet 4.6 to the "More" menu ([#999](https://github.com/utensils/claudette/issues/999)) ([9d7972e](https://github.com/utensils/claudette/commit/9d7972e55c459f5bf89bac9fb36b8ef70fe28373))
...
* **agent:** place attachments before prompt text to follow longform-data-first guidance ([#1000](https://github.com/utensils/claudette/issues/1000)) ([cc73db2](https://github.com/utensils/claudette/commit/cc73db2ca417e2e1c23c903e382c865bc20655bb))
* **agent:** stop forwarding remote MCP servers into Codex thread config ([#1005](https://github.com/utensils/claudette/issues/1005)) ([ceb3b69](https://github.com/utensils/claudette/commit/ceb3b694605f0593e5d013a1d737819253bc7872))
* **chat:** re-invoke agent when any background task completes, not just Bash ([#1008](https://github.com/utensils/claudette/issues/1008)) ([4aafcba](https://github.com/utensils/claudette/commit/4aafcba1b3566761fce770a3f973e90394c573f0))
* **checkpoints:** reclaim checkpoint file data on workspace archive ([#1003](https://github.com/utensils/claudette/issues/1003)) ([626c3d2](https://github.com/utensils/claudette/commit/626c3d286a174c00f8c0479a6b5ad69eb82b54e8))
* **env:** fall back to login-only shell probe when interactive probe fails ([#1001](https://github.com/utensils/claudette/issues/1001)) ([cfd6767](https://github.com/utensils/claudette/commit/cfd67678d266d37a6e25595fc108048168ccf711))
...
* **agent:** add native scheduling tools ([#868](https://github.com/utensils/claudette/issues/868)) ([0686280](https://github.com/utensils/claudette/commit/06862807a5ca005ae6b2b3d275878764338f9c3f))
...
* **chat:** enable Claude Remote Control mid-turn via deferred queue ([#849](https://github.com/utensils/claudette/issues/849)) ([140a68c](https://github.com/utensils/claudette/commit/140a68ce70b46d24ffd472e38020a40756f32fa2))
...
* **chat:** show env prep empty state ([41f4c4e](https://github.com/utensils/claudette/commit/41f4c4eba639bebd078883dfc0088dacbe35145c)), closes [#930](https://github.com/utensils/claudette/issues/930)
...
* **codex:** surface update_plan tasks ([#876](https://github.com/utensils/claudette/issues/876)) ([3a0cc6e](https://github.com/utensils/claudette/commit/3a0cc6e3d3b6d587a05fe9d3b292fd83f7d5d54c))
* **composer:** keep turn config editable during env prep ([#891](https://github.com/utensils/claudette/issues/891)) ([1bdc663](https://github.com/utensils/claudette/commit/1bdc663809f9f04dfe2decc9850312eac5735e3a))
* **composer:** support fuzzy file mention matching ([#966](https://github.com/utensils/claudette/issues/966)) ([d434064](https://github.com/utensils/claudette/commit/d43406465aae269ae40313b815d5817d733e33ce))
* **composer:** vertically resize the chat input like the sidebars ([#960](https://github.com/utensils/claudette/issues/960)) ([2e75179](https://github.com/utensils/claudette/commit/2e75179eda3b5ee4ea04aae309c6471a2206824c)), closes [#929](https://github.com/utensils/claudette/issues/929)
...
* **files:** reveal active editor file in tree ([#887](https://github.com/utensils/claudette/issues/887)) ([897d82c](https://github.com/utensils/claudette/commit/897d82c79af3abe1382e2a45455e2f99af481002))
...
* **monaco:** open agent-managed files (plans, memory) in Monaco ([#903](https://github.com/utensils/claudette/issues/903)) ([46984ef](https://github.com/utensils/claudette/commit/46984ef943486a3854d040f7941d89e7802fd6c8))
...
* **pi:** implement /compact on the Pi SDK harness via session.compact() ([#902](https://github.com/utensils/claudette/issues/902)) ([7010af1](https://github.com/utensils/claudette/commit/7010af191eecb09346f6f2814cc77885cdd7a399))
...
* **project-view:** add Open/Mine filter toggle to the Issues tab ([#977](https://github.com/utensils/claudette/issues/977)) ([1173736](https://github.com/utensils/claudette/commit/11737367ddfa2181e97d80a6c07e2edb124c9b58))
* **project-view:** open issues + PRs on repo overview, with right-click send-to-workspace ([#895](https://github.com/utensils/claudette/issues/895)) ([796fec3](https://github.com/utensils/claudette/commit/796fec32ae135d12a846393d68edc6b5c2681e18))
* **project-view:** persist issue/PR to workspace association from "Send to new workspace" ([#907](https://github.com/utensils/claudette/issues/907)) ([64bc3c0](https://github.com/utensils/claudette/commit/64bc3c08939c97932a85ccb781345db53c0170f6))
...
* queue project view workspace sends ([#916](https://github.com/utensils/claudette/issues/916)) ([511902e](https://github.com/utensils/claudette/commit/511902e8941b6a4060148aa3b61b06773f4ab5a2))
* **repo:** prompt for declared inputs on workspace create ([#807](https://github.com/utensils/claudette/issues/807)) ([f04dd96](https://github.com/utensils/claudette/commit/f04dd96a502099b417738e8fafde1cdcd7884374))
* **right-sidebar:** remember Files/Changes/Tasks tab per workspace ([#850](https://github.com/utensils/claudette/issues/850)) ([1b2305c](https://github.com/utensils/claudette/commit/1b2305c4e954d825e497e23da4e531670765c49e))
* **server:** add get_chat_snapshot RPC for WSS recovery ([#843](https://github.com/utensils/claudette/issues/843)) ([7a49a77](https://github.com/utensils/claudette/commit/7a49a779068759917cf26a388303574e04a74c2c))
* **server:** add restore_workspace RPC for headless / mobile use ([#845](https://github.com/utensils/claudette/issues/845)) ([95cad62](https://github.com/utensils/claudette/commit/95cad6299ed7abc16e3d26a9dcb28da81468bd03))
* **settings:** auto-fix CI failures with chat launcher hook ([#770](https://github.com/utensils/claudette/issues/770)) ([9dd5942](https://github.com/utensils/claudette/commit/9dd5942ba6f1b82d102ea457c779c22db1c676b5))
* **settings:** graduate experimental features ([#877](https://github.com/utensils/claudette/issues/877)) ([42f52f2](https://github.com/utensils/claudette/commit/42f52f2ac0cfeaba9cfb0103930ec199f98ba379))
...
* **sidebar:** mode-aware Cmd+1-9 with status-mode workspace jumps ([#945](https://github.com/utensils/claudette/issues/945)) ([a3c5295](https://github.com/utensils/claudette/commit/a3c52951575a26700fb8938f7fdedaa27e675c9f))
* **storage:** cleanup-all button and live progress for bulk archive cleanup ([#857](https://github.com/utensils/claudette/issues/857)) ([1d48fa9](https://github.com/utensils/claudette/commit/1d48fa9e8eed3418ba7254d5676834092242b7a8))
* **storage:** worktree disk-size display, per-repo storage stats, and orphaned-worktree cleanup ([#872](https://github.com/utensils/claudette/issues/872)) ([a1ef81e](https://github.com/utensils/claudette/commit/a1ef81e1b428758a167db7a8ddc7d20e37a13ac6))
...
* **terminal:** search scrollback with Cmd/Ctrl+F ([#973](https://github.com/utensils/claudette/issues/973)) ([4dd59c5](https://github.com/utensils/claudette/commit/4dd59c528e5182aac535f6abd0337b0cf29a2013))
* **theme:** add semantic design tokens and Base16 auto-import ([#799](https://github.com/utensils/claudette/issues/799)) ([326fe27](https://github.com/utensils/claudette/commit/326fe27fb9aa24a1fcc8502c928b5e17ba4e8542))
* **toast:** move toast notifications to upper-right corner ([#921](https://github.com/utensils/claudette/issues/921)) ([b58dde7](https://github.com/utensils/claudette/commit/b58dde7635495654819cc773a69f1a8235a9fa83)), closes [#920](https://github.com/utensils/claudette/issues/920)
* **updater:** explain boot probation rollbacks ([#922](https://github.com/utensils/claudette/issues/922)) ([952b007](https://github.com/utensils/claudette/commit/952b007a37acdfae0f40d04b32cbbee5e999f48a))
...
* **usage:** multi-provider usage meter, gate Claude OAuth path behind 'Claude Code Usage' ([#842](https://github.com/utensils/claudette/issues/842)) ([858dfdd](https://github.com/utensils/claudette/commit/858dfdd7b31b5cfe34f16e13fbc1d4ddd7215a50))
* **usage:** surface Pi usage and OpenRouter credits ([#880](https://github.com/utensils/claudette/issues/880)) ([a71c46d](https://github.com/utensils/claudette/commit/a71c46d2ea2c46a5260cbd3ababd78713fe46d7d))
...
* **workspaces:** bulk cleanup for archived workspaces ([#841](https://github.com/utensils/claudette/issues/841)) ([efe6fdc](https://github.com/utensils/claudette/commit/efe6fdc3fad649c8ccd193805e8009bb92922e6b))
* **workspaces:** expose "Discover worktrees" from the Workspaces sidebar ([#933](https://github.com/utensils/claudette/issues/933)) ([ca7b37b](https://github.com/utensils/claudette/commit/ca7b37b51e014c2d4aa01317e35ead960651411e))


### Bug Fixes

* cap mdns_sd logs for diagnostics debug level ([#969](https://github.com/utensils/claudette/issues/969)) ([7c14950](https://github.com/utensils/claudette/commit/7c14950234c3ba1bad1a57c0d3ae167f849e6854))
* **chat:** auto-dispatch queued messages on background workspaces ([#852](https://github.com/utensils/claudette/issues/852)) ([572c6b6](https://github.com/utensils/claudette/commit/572c6b6ae6fbeb65dcd967cc20402ce3e0a9e4eb))
* **chat:** cap terminal.output growth and dedupe background mirrors ([#937](https://github.com/utensils/claudette/issues/937)) ([#949](https://github.com/utensils/claudette/issues/949)) ([82b2a72](https://github.com/utensils/claudette/commit/82b2a720a143e983ee7d0fb364ec09c3e582b260))
* **chat:** drop env retry button from preparing empty state ([#954](https://github.com/utensils/claudette/issues/954)) ([2ae286d](https://github.com/utensils/claudette/commit/2ae286d2378cbed5d849a3be7db93676f830d2e1))
...
* **chat:** open cross-worktree file links in Monaco instead of the OS ([#847](https://github.com/utensils/claudette/issues/847)) ([86afe3e](https://github.com/utensils/claudette/commit/86afe3eaad96bc0058f648b0b45e193da655b7e4))
* **chat:** open plan file paths in Monaco instead of the OS editor ([#859](https://github.com/utensils/claudette/issues/859)) ([f23ec66](https://github.com/utensils/claudette/commit/f23ec66775b0e498ba6cb3cb6f8366a20af74483))
...
* **chat:** preserve steering prompt preview during workspace switches ([#913](https://github.com/utensils/claudette/issues/913)) ([b825043](https://github.com/utensils/claudette/commit/b825043a0b138e4587e293b1ff9fdd33b582be9d))
* **chat:** remove false-firing "Agent may be stuck" turn affordance ([#950](https://github.com/utensils/claudette/issues/950)) ([3e8d9a5](https://github.com/utensils/claudette/commit/3e8d9a5d23914cf436eafa5e800efab046bee1f6))
* **chat:** render AskUserQuestion picker fallback ([#939](https://github.com/utensils/claudette/issues/939)) ([6c278d4](https://github.com/utensils/claudette/commit/6c278d4fdba95d7ae697951303465e5e814c310d))
* **chat:** reset transcript view on session switch ([#938](https://github.com/utensils/claudette/issues/938)) ([d1850f5](https://github.com/utensils/claudette/commit/d1850f58b6e2f139c6b9137e1795cc7a939fa15e))
...
* **chat:** route control requests from wake turns ([#971](https://github.com/utensils/claudette/issues/971)) ([df4b277](https://github.com/utensils/claudette/commit/df4b277091fa3d07ed05b38a54d6966c0c3d4bae))
* **chat:** show Claude tool file paths while inline ([31d696a](https://github.com/utensils/claudette/commit/31d696a3c75d1da7af148596c9c7a87fa059c384))
* **chat:** stop duplicating AskUserQuestion cards after user answers ([#961](https://github.com/utensils/claudette/issues/961)) ([bbf09c4](https://github.com/utensils/claudette/commit/bbf09c4117a0b141cb7c4a4409e3d26a717a64fe))
...
* **checkpoints:** content-address blob storage + retention + backfill ([b70fbd6](https://github.com/utensils/claudette/commit/b70fbd66d1715b98803e56cb30f571072fa3f0ec))
* **ci:** scope tauri-action to src-tauri and stamp src-mobile in nightly ([#853](https://github.com/utensils/claudette/issues/853)) ([a55c380](https://github.com/utensils/claudette/commit/a55c38047cb498b7ebf4fbb66e071e683a268ae1))
* **codex:** emit one assistant block per item so text and thinking stream cleanly ([#870](https://github.com/utensils/claudette/issues/870)) ([f5bc180](https://github.com/utensils/claudette/commit/f5bc1805e450e7906912daf1dbc097ac7015ff22)), closes [#865](https://github.com/utensils/claudette/issues/865)
* **codex:** recover app-server auth in devshell worktrees ([#983](https://github.com/utensils/claudette/issues/983)) ([9e9badb](https://github.com/utensils/claudette/commit/9e9badbcb41f9163bc60ef2e9d79a414e16bf8f0))
* **codex:** route /compact to thread/compact/start on Codex Native ([#882](https://github.com/utensils/claudette/issues/882)) ([1620e84](https://github.com/utensils/claudette/commit/1620e84e1f264cd9d682abb010c9985878dd2b6c))
* **codex:** surface auth-expiry stderr + tear down stale session on /login ([#883](https://github.com/utensils/claudette/issues/883)) ([2dad96f](https://github.com/utensils/claudette/commit/2dad96f3ff5f04f0c4e811b11c09e022d242e404))
* **codex:** tolerate app-server stdout preambles ([ea0cd7a](https://github.com/utensils/claudette/commit/ea0cd7ad21248e32c54690722481005440ad5a4b))
* **command-palette:** cache file search results ([#863](https://github.com/utensils/claudette/issues/863)) ([9241a4f](https://github.com/utensils/claudette/commit/9241a4f5b3a4f4019f20416ffea3c972f46bd404))
...
* **command-palette:** stop Escape from cancelling running agent and revealing main menu ([#871](https://github.com/utensils/claudette/issues/871)) ([6675be2](https://github.com/utensils/claudette/commit/6675be2abf7a5f1f7acbb825987bc0232cb15eff))
...
* **db:** reclaim SQLite free pages ([#908](https://github.com/utensils/claudette/issues/908)) ([57a157c](https://github.com/utensils/claudette/commit/57a157ca98e1b47c791bfdce3d0ea1b3ea4d4bee))
...
* **env-direnv:** cache thrashes on workspaces with no source changes ([#912](https://github.com/utensils/claudette/issues/912)) ([d277d6c](https://github.com/utensils/claudette/commit/d277d6c02b938a7c7f56cb55fb1af9bfaa4c1cef))
...
* **env:** recover stalled workspace preparation ([#946](https://github.com/utensils/claudette/issues/946)) ([09e8b27](https://github.com/utensils/claudette/commit/09e8b27aeaabd1a83300c6bda6b886d1a6b54942))
* **files:** retain Monaco scroll state across tab switches ([#974](https://github.com/utensils/claudette/issues/974)) ([17a9683](https://github.com/utensils/claudette/commit/17a96830d06a9f41cdcb88cb9af8511175c98687))
...
* keep codex auto-compaction turns alive ([#911](https://github.com/utensils/claudette/issues/911)) ([d41bcf4](https://github.com/utensils/claudette/commit/d41bcf4c9b593d420563d26eae13275080ec98f4))
* keep Codex shell tab active during commands ([#866](https://github.com/utensils/claudette/issues/866)) ([21ceefc](https://github.com/utensils/claudette/commit/21ceefc0b572003eea99f580fe93becdd75ba093))
* keep non-Claude usage meters ungated ([#959](https://github.com/utensils/claudette/issues/959)) ([43f25b4](https://github.com/utensils/claudette/commit/43f25b44d56956ccb82b2023687ed63839610c82))
* make OpenRouter balance always on ([#900](https://github.com/utensils/claudette/issues/900)) ([1338d10](https://github.com/utensils/claudette/commit/1338d108a152a68e7550352156cf4171d9862bc0))
* **metrics:** preserve stats across workspace cleanup ([0cc12e1](https://github.com/utensils/claudette/commit/0cc12e18f786cb9ff730b451c1fae8ca0c974b85))
...
* **pi:** repair turn/context lifecycle — visible auto-compaction, accurate meter, unhanging tool calls ([#951](https://github.com/utensils/claudette/issues/951)) ([0551210](https://github.com/utensils/claudette/commit/05512106018baa7674687a19ce0ad07c86e2eab3))
* **plan-mode:** persist per-session toggle so off-state survives restart ([#981](https://github.com/utensils/claudette/issues/981)) ([6b03458](https://github.com/utensils/claudette/commit/6b03458e8481ea8a4dc0fd758085026edb10a438))
...
* reduce idle scheduler and polling wakeups ([#979](https://github.com/utensils/claudette/issues/979)) ([4326963](https://github.com/utensils/claudette/commit/4326963db9f184577dfb3a1d4e0ec906270476e7))
...
* **settings:** align storage size badges to a consistent right-side column ([#972](https://github.com/utensils/claudette/issues/972)) ([a0850b5](https://github.com/utensils/claudette/commit/a0850b5bb8c446f2b09991581b770ddb2f394129))
* **settings:** sidebar scrolls under macOS window controls; dialog badge overflow ([#879](https://github.com/utensils/claudette/issues/879)) ([4909951](https://github.com/utensils/claudette/commit/4909951c7e191403377886aa54209ede2b44c0de))
* **settings:** support Codex plan mode controls ([#957](https://github.com/utensils/claudette/issues/957)) ([0793910](https://github.com/utensils/claudette/commit/0793910479198ffd4cfa8a5a507e550461ded010))
...
* stabilize live elapsed turn timer ([#947](https://github.com/utensils/claudette/issues/947)) ([1a65a83](https://github.com/utensils/claudette/commit/1a65a83eb57ea37befb4a0b78127ba9ba5d44c7c))
* **storage:** show reclaimable checkpoint bytes in archived-workspace cleanup dialog ([#970](https://github.com/utensils/claudette/issues/970)) ([4255745](https://github.com/utensils/claudette/commit/425574552b87fca51bd0723a9dc87ba2b9bfb16c))
...
* **tasks:** kill elastic scroll bounce + auto-scroll to active task in Tasks sidebar ([#901](https://github.com/utensils/claudette/issues/901)) ([0ca397e](https://github.com/utensils/claudette/commit/0ca397e3c4ce4434b7a9e36af332ce7cbbd0e702))
...
* **updater:** raise boot probation timeout to 20s ([#892](https://github.com/utensils/claudette/issues/892)) ([d33e70c](https://github.com/utensils/claudette/commit/d33e70c09a5bc7243ceb0812f64c34e9d1458454))
* **windows:** default subprocesses to no console window ([5781656](https://github.com/utensils/claudette/commit/5781656486338daf8c3343b18cec5e3fe2c9f143))
* **windows:** import GlobalFree from Win32::Foundation ([#962](https://github.com/utensils/claudette/issues/962)) ([212db81](https://github.com/utensils/claudette/commit/212db81501a0f759bbd96821bedc3d44950139d1))
* **workspace:** prevent duplicate workspace creation on app reload ([#905](https://github.com/utensils/claudette/issues/905)) ([6402552](https://github.com/utensils/claudette/commit/640255220dbc5cf9bb93ed9fb61415f61a98326a)), closes [#896](https://github.com/utensils/claudette/issues/896)
...
* **command-palette:** speed up Cmd+P file search ([#944](https://github.com/utensils/claudette/issues/944)) ([98eb86b](https://github.com/utensils/claudette/commit/98eb86bc2d6e630090d3d295459c53d366a5e96d))
* **right-sidebar:** cache workspace files and changes ([#856](https://github.com/utensils/claudette/issues/856)) ([1e6a814](https://github.com/utensils/claudette/commit/1e6a8147cb2c996e235e333222cbbde9391538cc))
