...
Only **Claude Code Usage** lives there today. Agent backend choices such as Ollama, LM Studio, OpenAI API, and Codex live in **Settings > Models** as first-class model/provider controls. Claude Code Plugin Management, Claude Remote Control, Community Registry, and Claudette Terminal are visible by default in their normal settings locations.
