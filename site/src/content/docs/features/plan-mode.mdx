...
Plan mode follows the active runtime. Claude-compatible sessions use Claude Code's plan approval flow; Codex Native sessions use Codex's `collaborationMode: plan` workflow.
