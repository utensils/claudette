...
{/* TODO: Screenshot of Notifications settings panel */}
:::note[Screenshot coming soon]
A screenshot of the Notifications settings panel will be added here.
:::
...
- **Install** a pack (Claudette clones it locally via `git`)
- **Update** an installed pack to the latest commit
...
We maintain two community packs that pair well with Claudette's defaults — both are available in the OpenPeon registry:
...
Both are searchable in the in-app browser; you can also install them by URL if your registry mirror differs.
...
The tray icon also reflects unattended workspaces — see [Settings](/claudette/features/settings/) for the per-workspace attention behaviour.
