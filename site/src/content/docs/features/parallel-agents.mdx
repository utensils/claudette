...
Use the opener in the workspace header to launch the current worktree in a detected editor, file manager, terminal, or IDE. The primary icon opens the first preferred detected app; the chevron shows the full app list and a copy-path action.
