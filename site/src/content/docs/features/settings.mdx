...
| Default effort / Codex reasoning effort | Claude models use effort levels (`auto`, `low`, `medium`, `high`, `xhigh`, `max` where supported). Experimental Codex uses Codex reasoning effort (`default`, `none`, `minimal`, `low`, `medium`, `high`, `xhigh`). | Auto / Default |
| Default thinking / Codex reasoning | Enable extended thinking for Claude or reasoning for Experimental Codex. | Off |
