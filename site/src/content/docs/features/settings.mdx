...
Claude Code Plugins, Claude Remote Control, and Community Registry are first-class settings surfaces and are visible by default. Legacy Experimental off values for these graduated features are ignored after upgrading and no longer hide their settings surfaces.
