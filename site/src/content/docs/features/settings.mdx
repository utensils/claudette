...
| Group adjacent tool calls | Collapse adjacent regular tool calls into summary blocks. When off, every top-level tool call, Agent call, and thinking block is shown inline. (**Brink** Mode) | On |
