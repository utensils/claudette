...
| Agent backend cards | Enable, test, authenticate, and refresh model lists for built-in providers such as Claude Code, Codex, Ollama, LM Studio, and OpenAI API. | Provider-specific |
