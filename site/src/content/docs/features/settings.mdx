...
| Setting | Description | Default |
|---------|-------------|---------|
| Default model | Model for new chats (Opus 5, Sonnet 5, Haiku 4.5, Fable 5.1; older models such as Fable 5 / Fable 5 1M, Opus 4.8 / 4.7 / 4.6 / 4.5 and Sonnet 4.6 / 4.6 1M remain selectable behind the picker's "More" disclosure) | — |
