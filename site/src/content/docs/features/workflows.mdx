...
The card is expanded by default. Collapsing it hides the agent tree but keeps the header and progress rail visible, and your choice persists for that run.
