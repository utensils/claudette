...
import repoSpecificPins from '../../../assets/screenshots/repo-specific-pins.png';
...
<Image src={repoSpecificPins} alt="Repository settings page with a Pinned Prompts section and an Inherited from Global list below it" loading="lazy" />
