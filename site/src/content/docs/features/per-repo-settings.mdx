...
The same actions are also available without the modal from the env-panel error card in Repo Settings → Environment, for users who dismissed the prompt or want to revisit their decision.
