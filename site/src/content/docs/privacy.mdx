...
| `openrouter.ai/api/v1/credits` | OpenRouter credit balance for the usage meter | While an OpenRouter-backed session is active and **OpenRouter balance in usage meter** is enabled |
