...
Pick the launcher that matches your platform — `--new`, `--clean`, and `-h`/`--help` work on both. `--clone` (copy-on-write snapshot of your real setup) is currently macOS/Linux only.
...
<Tabs>
  <TabItem label="macOS / Linux">
    ...
    # Per-PID copy-on-write snapshot of your real setup; isolated from
    # the running release app
