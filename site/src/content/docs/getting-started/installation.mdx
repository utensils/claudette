...
:::note
Linux `.AppImage` is temporarily unavailable while the bundler issue documented in [#824](https://github.com/utensils/Claudette/pull/824) is resolved. Install via `.deb` until AppImage is restored.
:::
